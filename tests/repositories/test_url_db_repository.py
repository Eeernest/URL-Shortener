...
async def test_get_by_long_url(url_db_repo, saved_url_obj):
  result = await url_db_repo.get_by_long_url(saved_url_obj.long_url)
...
@pytest.mark.anyio
@pytest.mark.integration
async def test_get_by_short_code(url_db_repo, saved_url_obj):
  result = await url_db_repo.get_by_short_code(saved_url_obj.short_code)
...
@pytest.mark.anyio
@pytest.mark.integration
async def test_save(url_db_repo, create_url_obj):
  result = await url_db_repo.save(create_url_obj)
