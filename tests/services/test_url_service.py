...
from tests.fixtures.url_fixture import mock_db_repo, mock_url_obj, create_url_obj, mock_base_url, url_service

def test_get_or_create_get_success(mock_db_repo, mock_url_obj, create_url_obj, url_service):
  mock_db_repo.get_long_url.return_value = mock_url_obj
  ...
  assert mock_db_repo.get_long_url.assert_called_once
...
def test_get_or_create_create_success(mock_db_repo, mock_url_obj, create_url_obj, url_service):
  mock_db_repo.get_long_url.return_value = None
